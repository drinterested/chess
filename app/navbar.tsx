      ...
      <div className="container flex h-16 items-center justify-between">
        <div className="flex items-center gap-2">
            ...
            <SheetContent side="left" className="w-[240px] sm:w-[300px]">
              <div className="flex flex-col gap-4 py-4">
                <Link href="/" className="flex items-center gap-2" onClick={() => setIsOpen(false)}>
                  <Image src="/logo.png" alt="Simmon Chang Chess Club Logo" width={100} height={100} />
                </Link>
          ...
          <Link href="/" className="flex items-center gap-2">
            <Image src="/logo.png" alt="Simmon Chang Chess Club Logo" width={40} height={40} className="hidden md:block" />
            <div className="font-semibold text-sm hidden md:block">
              <span className="text-[#405862]">Simmon Chang</span> Chess
            </div>
          </Link>
        </div>
