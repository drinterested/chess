    ...
    <footer className="bg-[#405862] text-white" role="contentinfo">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <Link href="/" className="flex items-center gap-3 mb-4 group">
              ...
              <div className="font-bold text-sm">
                <div className="text-white">Simmon Chang</div>
                <div className="text-[#4ecdc4]">Chess Club</div>
              </div>
            </Link>
            <p className="text-gray-300 mb-6 max-w-md leading-relaxed">
              CFC-rated chess tournaments raising funds for the Pediatric Cancer Research Foundation. Part of Dr. Interested,
              a youth-led global pre-med community dedicated to supporting cancer research.
            </p>
          ...
          {/* Main Website Links */}
          <div>
            <h3 className="font-semibold text-lg mb-4 text-[#4ecdc4]">Dr. Interested</h3>
            <ul className="space-y-3">
              <li>
                <Link
        ...
        <div className="border-t border-gray-600 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="text-gray-300 text-sm">
              <p>© {currentYear} Dr. Interested Simmon Chang Chess Club. All rights reserved.</p>
              <p className="mt-1">Supporting cancer research through competitive chess tournaments.</p>
            </div>
